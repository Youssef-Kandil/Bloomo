    ...
    '[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]',
  {
    variants: {
      variant: {
        ...
        gradient:
          'bg-gradient-to-r from-primary to-accent text-white shadow-soft hover:shadow-glow hover:brightness-110',
        destructive:
          'bg-destructive text-destructive-foreground shadow-soft hover:brightness-110',
        outline:
          'border border-border bg-surface shadow-soft hover:bg-muted hover:text-foreground',
